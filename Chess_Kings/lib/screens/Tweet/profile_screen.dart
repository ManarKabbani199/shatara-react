          ...
          builder: (_, controller) => Column(
            children: [
              const Padding(
                ...
                child: Text('المتابِعون / المتابَعون', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ),
              Expanded(
              ...
              SafeArea(
                child: Column(
                  children: [
                    ...
                    // ✅ البانر/الصورة في الأعلى (سطح المكتب: في المنتصف أعلى الصفحة) (الجوال: في الأعلى + شريط أحمر بالنص)
                    _TopHeroBanner(isMobile: isMobile),
...
class _TopHeroBanner extends StatelessWidget {
  final bool isMobile;
  const _TopHeroBanner({required this.isMobile});

  @override
  Widget build(BuildContext context) {
    if (isMobile) {
      // 📱 الجوال: الصورة بالأعلى + شريط أحمر بالنص
      return Column(
        children: [
          Padding(
    ...
    // 🖥️ سطح المكتب: الصورة في المنتصف وأعلى الصفحة
    return Padding(
