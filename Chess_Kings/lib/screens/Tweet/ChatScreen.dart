...
import '../../Widget/TweetsPage/SendMessageWidget.dart';
...
class _ChatScreenState extends State<ChatScreen> with SingleTickerProviderStateMixin {
  ...
  /// --------------------------
  /// قسم أعلى الصفحة: صورة + (على الجوال) شريط تنبيه أحمر
  /// --------------------------
  Widget _topBanner(bool isMobile) {
    if (isMobile) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            // الصورة أعلى الجوال في المكان الفارغ
            Center(
              child: Image.asset(
                'assets/test.png',
                height: 55,
    ...
    // Desktop/Web: الصورة في المنتصف وأعلى الصفحة
    return Padding(
  ...
  Widget _chatArea() {
    return Container(
      color: Colors.white60, // ✅ خلفية بيضاء
      child: Column(
        children: [
          Expanded(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Scaffold(
            backgroundColor: Color(0xFFDDDDDC),
              ...
              SafeArea(
                child: Column(
                  children: [
                    ...
                    // ✅ القسم الجديد أعلى الصفحة حسب المنصة
                    _topBanner(isMobile),
                      ...
                      child: isMobile
                        ...
                        child: Column(
                          children: [
                            ...
                            // ✅ الشات على الموبايل داخل مساحة ثابتة الارتفاع لتجنّب Expanded داخل Scroll
                            SizedBox(
            ...
            child: Directionality(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  isLoggedIn
                      ? _HoverDrawerItem(label: 'تسجيل الخروج', route: '/main', isAlwaysActive: true, onTapOverride: () async {
