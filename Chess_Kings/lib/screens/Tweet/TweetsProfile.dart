...
class TweetsProfile extends StatefulWidget {
  final String userId;
  const TweetsProfile({super.key, required this.userId});

  @override
  State<TweetsProfile> createState() => _TweetsProfileState();
}

class _TweetsProfileState extends State<TweetsProfile> with SingleTickerProviderStateMixin {
  ...
  // ✅ بانر الجوال: الصورة + شريط أحمر بالنص
  Widget _mobileTopBanner() {
    return Column(
      children: [
  ...
  // ✅ بانر الكمبيوتر: صورة مثبتة أعلى الصفحة في المنتصف (داخل الـ Stack)
  Widget _desktopTopBanner() {
    return Positioned(
      top: 8,
      left: 0,
      right: 0,
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              // ✅ بانر الكمبيوتر (مثبت بالأعلى)
              if (!isMobile) _desktopTopBanner(),

              SafeArea(
                child: Column(
                  children: [
                    // ✅ بانر الجوال في أعلى المساحة الفارغة
                    if (isMobile) _mobileTopBanner(),
                            ...
                            StreamBuilder<QuerySnapshot>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                                  return const Center(child: Text('لا توجد مشاركات.'));
                                }
