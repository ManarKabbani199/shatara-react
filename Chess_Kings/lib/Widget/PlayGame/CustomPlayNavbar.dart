...
class CustomPlayNavbar extends StatefulWidget {

  const CustomPlayNavbar({super.key});

  @override
  State<CustomPlayNavbar> createState() => _CustomPlayNavbarState();
}

class _CustomPlayNavbarState extends State<CustomPlayNavbar> {
  String? hoveredRoute;
  ...
  List<Widget> _buildNavItems(BuildContext context) {
    ...
    return [
      ...
      spacing,
      _navButton('ألعب الأن', '/playNow', isSpecialActive: true),
      spacing,
