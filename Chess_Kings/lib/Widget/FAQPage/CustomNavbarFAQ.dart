...
class CustomNavbarFAQ extends StatefulWidget {
  const CustomNavbarFAQ({super.key});

  @override
  State<CustomNavbarFAQ> createState() => _CustomNavbarFAQState();
}

class _CustomNavbarFAQState extends State<CustomNavbarFAQ> {
  String? hoveredRoute;
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Container(
        ...
        // ✅ للجوال: زر القائمة — للديسكتوب: Wrap يمنع أي Overflow أو unbounded flex
        child: isMobile ? _buildDrawerIcon(context) : _buildDesktopNav(context),
      ),
    );
  }

  // ======= Desktop (Wrap بدلاً من Row + Spacer) =======
  Widget _buildDesktopNav(BuildContext context) {
    const spacing = SizedBox(width: 5);
    return Align(
      alignment: Alignment.centerRight,
      child: Wrap(
        alignment: WrapAlignment.end,               // يمين
        ...
        children: [
          ...
          MouseRegion(
            ...
            child: GestureDetector(
              ...
              child: Image.asset('assets/logon.png', height: 40),
            ),
          ),
          spacing,
          ...
          spacing,
          _navButton('الأسئلة الشائعة', '/faq', isSpecialActive: true),
          spacing,
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min, // ✅ لا توسّع
            children: [
