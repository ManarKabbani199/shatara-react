...
class CustomNavbarAbout_Chess extends StatefulWidget {
  const CustomNavbarAbout_Chess({super.key});

  @override
  State<CustomNavbarAbout_Chess> createState() => _CustomNavbarAbout_ChessState();
}

class _CustomNavbarAbout_ChessState extends State<CustomNavbarAbout_Chess> {
  String? hoveredRoute;
