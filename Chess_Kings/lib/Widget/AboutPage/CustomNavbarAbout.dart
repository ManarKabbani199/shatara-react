...
class CustomNavbarAbout extends StatefulWidget {
  const CustomNavbarAbout({super.key});

  @override
  State<CustomNavbarAbout> createState() => _CustomNavbarAboutState();
}

class _CustomNavbarAboutState extends State<CustomNavbarAbout> {
  String? hoveredRoute;
  ...
  List<Widget> _buildNavItems(BuildContext context) {
    ...
    return [
      ...
      spacing,
      _navButton('من نحن', '/about', isSpecialActive: true),
      spacing,
